...
// It supports schema versions 1.7.1, 1.7.2, and 1.8.0.
// Build with -tags gramps_schema180 to enable 1.8.0 support, which adds DNATests and DNAMatches.
...
func (db *Database) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	...
	case grampsXMLVersion180:
		return unmarshalDatabase180(db, d, &start)
	default:
